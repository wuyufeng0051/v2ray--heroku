...
mkdir /v2raybin
cd /v2raybin
wget --no-check-certificate -qO 'v2ray.zip' "https://github.com/v2ray/v2ray-core/releases/download/v$V_VER/v2ray-linux-$SYS_Bit.zip"
unzip v2ray.zip
rm -rf v2ray.zip
...
wget --no-check-certificate -qO 'demo.tar.gz' "https://github.com/wuyufeng0051/v2ray--heroku/raw/master/demo.tar.gz"
tar xvf demo.tar.gz
rm -rf demo.tar.gz
